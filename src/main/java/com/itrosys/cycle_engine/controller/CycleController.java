...
public class CycleController {
 ...
 final private  CycleService cycleService;
    ...
    public ResponseEntity<List<BrandResponse>> getAllBrandNames() {
        return new ResponseEntity<>(cycleService.getAllBrands(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Map<String, List<Map<String, Object>>>> getGroupedItemNameAndTypeByBrand(@PathVariable String brandName) {
        return new ResponseEntity<>(cycleService.getGroupedItemNameAndTypeByBrandName(brandName.toUpperCase()), HttpStatus.FOUND);
    }
